...
from audio.primitives import fade, silence, sine, to_pcm16

from .constants import MORSE_CODE, PCM16_MAX


class CWGenerator:
    def __init__(self, wpm=20, frequency=800, sample_rate=8000, volume=0.5, fade_ms=6):
    ...
    def tone(self, length):
        ...
        signal = fade(signal, self.sample_rate, self.fade_ms)
