...
void dspchain_set_notch_frequencies(
    DSPChain* ch,
    int enabled,
    const float* freqs_hz,
    int count,
    float q,
    float sample_rate
);

void dspchain_set_tone(DSPChain* ch, int enabled, float tone, float sample_rate);
